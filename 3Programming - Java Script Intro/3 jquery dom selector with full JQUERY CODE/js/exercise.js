 ...
 * We've started you off, replace the sections with the appropriate text...
 */
 ...
 * Change the image to "http://lorempixel.com/g/500/400/food"
 * 
 */
...
/**
 * Question 9:
 * When button 3 is clicked, select all paragraphs on the page and change the color to blue and font to Georgia and font size to 50px.
 * Bonus: Try to do this with only one jQuery call. $("selector").css({attribute: "value", attribute: "value"});
 */

function question9() {
	$("p").css({"color": "blue","font-family": "Georgia", "font-size": "12px"});
}
